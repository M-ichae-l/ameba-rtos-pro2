...
#include "ameba_soc.h"
/* rtl8735b has no component/soc/8735b/fwlib/.../ameba_usb.h providing USB_REG_BASE /
 * USB_MAX_ENDPOINTS / USB_MAX_PIPES via ameba_soc.h, unlike other Ameba chips -
 * pull the local chip-constants header in explicitly instead. */
#include "ameba_usb.h"
...
#define USB_OTG_HOST_CHANNEL_XFER_SIZE_BASE				0x510UL
#define USB_OTG_HOST_CHANNEL_DMA_ADRR_BASE				0x514UL
...
#define USB_OTG_HCINTMSK_RESERVED_Pos            (14U)
#define USB_OTG_HCINTMSK_RESERVED_Msk            (0x3FFFUL << USB_OTG_HCINTMSK_RESERVED_Pos)    /*!< 0xFFFC0000 */
#define USB_OTG_HCINTMSK_RESERVED                 USB_OTG_HCINTMSK_RESERVED_Msk       /*!< Reserved for future use */
