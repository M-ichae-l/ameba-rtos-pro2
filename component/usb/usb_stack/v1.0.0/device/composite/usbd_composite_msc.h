...
/* RAM disk configuration (used when CONFIG_USBD_COMPOSITE_MSC_SD_MODE is not defined) */
#ifndef CONFIG_USBD_COMPOSITE_MSC_SD_MODE
...
typedef struct {
	...
	rtos_task_t rx_task;
	usb_os_sema_t rx_sema;
	rtos_task_t tx_task;
	usb_os_sema_t tx_sema;
	u32 num_sectors;
