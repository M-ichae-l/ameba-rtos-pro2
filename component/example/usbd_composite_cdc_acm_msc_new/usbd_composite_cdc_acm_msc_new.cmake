...
list(
	...
	# usbd_composite_cdc_acm.c/usbd_composite_cdc_acm_msc.c only reference
	# macros (USBD_COMP_CDC_*) defined by usbd_composite_config.h's
	# CDC-including branches - only one CONFIG_USBD_COMPOSITE_* combo may be
	# active per build (see the #if/#elif chain there), so these two are
	...
	${sdk_root}/component/usb/usb_stack/${usb_stack_ver}/device/composite/usbd_composite_cdc_acm.c
	${sdk_root}/component/usb/usb_stack/${usb_stack_ver}/device/composite/usbd_composite_cdc_acm_msc.c
)
...
# "usbd_composite_cdc_acm_msc.h" (from component/usb/usb_stack/${usb_stack_ver}/device/composite)
...
### add flags ###
# CONFIG_USBD_COMPOSITE_CDC_ACM_MSC selects the CDC ACM + MSC branch of
...
list(
	...
	CONFIG_USBD_COMPOSITE_CDC_ACM_MSC=1
)
